  ...
  <div class="container">
    <div class="box">
      <div class="box1">
        ...
        <div>
          <img :src="`/project/api/lecture/${detail.imageNum}/image?lecNum=${detail.imageNum}`"
        ...
        <!-- 댓글 목록-->
        <div v-for="lectureReview in lectureReview.data" :key="lectureReview.lecReNum">
