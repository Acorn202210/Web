          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu" role="menu">
                <a class="dropdown-item" role="presentation" @click="this.$router.push(`/lectureList/front/all`)">웹프론트엔드</a>
                <a class="dropdown-item" role="presentation"  @click="this.$router.push(`/lectureList/backend/all`)">백엔드</a>
                <a class="dropdown-item" role="presentation" @click="this.$router.push(`/lectureList/mobile/all`)">모바일</a>
              </div>
            </li>
